...
SELECT title FROM
songs WHERE mood = "epic" OR released > 1990;
...
1. In this first step, select the title of all the songs by the artist named 'Queen'.
Now you'll make a 'Pop' playlist.
2. In preparation, select the name of all of the artists from the 'Pop' genre.
